  ...
  <body>
	...
	<div class="container-fluid" id="MainArea">
			...
			<nav class="navbar navbar-fixed-top"  Style="margin: 0 auto; max-width: 70%">
				<div class="container-fluid">
					<div class="navbar-header" Style="padding-left: 10px">
						<a href="index.html"><img src="assets/tt.png" Height="48px" Width="48px" Style="margin-top: 10px; margin-botton: 2px"></img></a>
					</div>
		...
		<div Style="width: 100%">
				...
				<input class="form-control input-lg" id="inputlg" name="match" type="text"  Style="max-width: 200px; margin: 0 auto;" placeholder="Enter Text Here..." >
